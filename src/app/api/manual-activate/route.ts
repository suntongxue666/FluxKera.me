...
export async function POST(request: NextRequest) {
  try {
    // 手动激活订阅 I-JEU0NLCLGH9A 为 sunwei7482@gmail.com
    const subscriptionId = 'I-JEU0NLCLGH9A'
    ...
    const { error: transactionError } = await supabase
      ...
      .insert({
        ...
        amount: credits,
        type: 'subscription',
        description: `${planName} plan subscription - ${credits} credits (manual activation)`,
